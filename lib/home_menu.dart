import 'package:sphere/features/community/screens/message/message.dart';
import 'package:sphere/utils/constants/colors.dart';
import 'package:sphere/utils/helpers/helper_functions.dart';
      ...
      bottomNavigationBar: Obx(
        () => NavigationBar(
          ...
          destinations: const [
            ...
            NavigationDestination(icon: Icon(Iconsax.chart), label: '許願池'),
            NavigationDestination(
                icon: Icon(Iconsax.message_favorite), label: '訊息'),
            NavigationDestination(icon: Icon(Iconsax.user), label: '個人'),
          ],
        ),
      ),
